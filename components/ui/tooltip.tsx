...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        // 使用 sidebar 相似的颜色，圆角气泡样式，使用 flex + wrap 适配多行
        "z-50 flex flex-wrap overflow-hidden rounded-full bg-sidebar text-sidebar-foreground px-3 py-1.5 text-xs shadow-md",
