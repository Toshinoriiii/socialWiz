...
**Version**: 1.0.1 | **Ratified**: 2025-01-05 | **Last Amended**: 2026-04-03

**Patch (2026-04-03)**: 「标准化 OAuth」在平台集成中解释为：**官方 OAuth/API 适配器为可选能力**；产品可同时支持 **浏览器会话 + 非官方发布引擎**（见 `specs/main/plan.md`），二者通过服务层与类型区分，不视为违背平台无关原则。
